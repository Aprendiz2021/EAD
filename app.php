...
<div class="container theme-showcase" role="main">
            ...
            <tbody>
              <?php while($rows_cursos = mysqli_fetch_assoc($resultado_cursos)){ ?>
                <tr>
                  ...
                  <td>
                    <a type="button"  data-toggle="modal" data-target="#myModal<?php echo $rows_cursos['id']; ?>">Visualizar</a> /
                    <a type="button"  data-toggle="modal" data-target="#exampleModal" data-whatever="<?php echo $rows_cursos['id']; ?>" data-whatevernome="<?php echo $rows_cursos['nome']; ?>"data-whateverdetalhes="<?php echo $rows_cursos['cpf']; ?>">Editar</a>
                   
                  </td>
                </tr>
                <!-- Inicio Modal  btn btn-primary pull-right-->
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
        <form method="POST" action="C:\xampp\htdocs\escola\processa.php" enctype="multipart/form-data">
         


          <div class="form-group">
          <label for="recipient-name" class="control-label" style="color:#000;">nota1:</label>
          <input name="nota1" type="text" class="form-control" style="color:#000;" id="recipient-name">
          </div>
          <div class="form-group">
          <label for="message-text" class="control-label" style="color:#000;">nota2:</label>
          <textarea name="nota2" class="form-control" id="nota2" style="color:#000;"></textarea>
          </div>

          <div class="form-group">
          <label for="message-text" class="control-label" style="color:#000;">nota3:</label>
          <textarea name="nota3" class="form-control" id="nota3" style="color:#000;"></textarea>
          </div>

          <div class="form-group">
          <label for="message-text" class="control-label" style="color:#000;">nota4:</label>
          <textarea name="nota4" class="form-control" id="nota4" style="color:#000;"></textarea>
          </div>
