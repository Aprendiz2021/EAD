...
$query=mysqli_query($db,"delete from tblprova where ID='$id'");
if($query){
echo "<script>alert('Prova excluído com sucesso');</script>";
...
<div class="logo">
  ...
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">IRSEBA</a></li>
          ...
          <div class="col-md-8">
            <div class="card">
              <div class="card-header">
                ...
                <h5 class="title">Provas Adicionadas</h5>
              </div>
              <div class="col-md-12">
...
$ret=mysqli_query($con,"select * from quintoportugues where UserId='$userid'");
$cnt=1;
...
?>
              <tbody>
               ...
               <td><a href="provas.php?delid=<?php echo $row['ID'];?>">Excluir</a>
                </tr>
                <?php 
$cnt=$cnt+1;
}?>
