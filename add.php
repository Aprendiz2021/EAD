...
<div class="logo">
  ...
  <div class="content">
    ...
    <?php 
     if($_SESSION['usuarioSerie'] == 1){
       echo "<figure>
           <img src='img/1.jpg' alt='Minha Figura'> 
           <figcaption>Ano</figcaption>
        </figure>";
        include 'eddprovas/primeiro.php';
     }
     if($_SESSION['usuarioSerie'] == 2){
          echo "<figure>
           <img src='img/2.jpg' alt='Minha Figura'> 
           <figcaption>Ano</figcaption>
        </figure>";
        include 'eddprovas/segundo.php';
     }
     if($_SESSION['usuarioSerie'] == 3){
          echo "<figure>
           <img src='img/3.jpg' alt='Minha Figura'> 
           <figcaption>Ano</figcaption>
        </figure>";
        include 'eddprovas/terceiro.php';
     }
     if($_SESSION['usuarioSerie'] == 4){
          echo "<figure>
           <img src='img/4.jpg' alt='Minha Figura'> 
           <figcaption>Ano</figcaption>
        </figure>";
        include 'eddprovas/quarto.php';
     }
     if($_SESSION['usuarioSerie'] == 5){
          echo "<figure>
           <img src='img/5.jpg' alt='Minha Figura'> 
           <figcaption>Ano</figcaption>
        </figure>";
        include 'eddprovas/quinto.php';
