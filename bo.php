...
<div class="logo">
          ...
          <a href="javascript:void(0)" class="simple-text logo-largo">
            <?php   echo "". $_SESSION['usuarioProfissao']; ?> 
          </a>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title text-warning">Erika</h4>
              </div>
              <div class="card-body">
 <?php
require('conexao.php');

   $listagem = $conn->prepare("SELECT * FROM 1anoingles");
   $listagem ->execute();
   while ($lista = $listagem->fetch(PDO::FETCH_ASSOC) ): 

?><p class="text-primary">
<a style='color: #FF69B4;' class="info"><?php echo $lista["id"]; ?> </a> 
<a style='color: #FF69B4;'><?php echo $lista["nome"]; ?></a><br>
</p>
...
<?php endwhile; ?>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title text-warning">Andressa</h4>
              </div>
              <div class="card-body">
          <?php
require('conexao.php');

   $listagem = $conn->prepare("SELECT * FROM 2anoingles");
   $listagem ->execute();
   while ($lista = $listagem->fetch(PDO::FETCH_ASSOC) ): 
...
<?php endwhile; ?>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title text-warning">Malena</h4>
              </div>
              <div class="card-body">
          <?php
require('conexao.php');

   $listagem = $conn->prepare("SELECT * FROM 3anoingles");
   $listagem ->execute();
   while ($lista = $listagem->fetch(PDO::FETCH_ASSOC) ): 
...
<?php endwhile; ?>
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                <h4 class="card-title text-warning">Daiane - 4</h4>
              </div>
              <div class="card-body">
          <?php
require('conexao.php');

   $listagem = $conn->prepare("SELECT * FROM 4anoingles");
   $listagem ->execute();
   while ($lista = $listagem->fetch(PDO::FETCH_ASSOC) ): 
          ...
          <div class="col-md-6">
            <div class="card">
              <div class="card-header">
                ...
                <h4 class="card-title text-warning">Daiane - 5</h4>
              </div>
              <div class="card-body">
          <?php
require('conexao.php');

   $listagem = $conn->prepare("SELECT * FROM 5anoingles");
   $listagem ->execute();
   while ($lista = $listagem->fetch(PDO::FETCH_ASSOC) ): 
...
<h5 class="title">Olá, <i  style="color: #888;"><?php   echo "". $_SESSION['usuarioNome']; ?> </i> <br></h5>
