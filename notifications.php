...
$ret=mysqli_query($db,"SELECT 1anoportugues.nome, 1anoportugues.cpf from 1anoportugues where nome='$nome' = cpf='$cpf'
UNION
SELECT 2anoportugues.nome, 2anoportugues.cpf from 2anoportugues where nome='$nome' = cpf='$cpf'
UNION
SELECT 3anoportugues.nome, 3anoportugues.cpf from 3anoportugues where nome='$nome' = cpf='$cpf'
UNION
SELECT 4anoportugues.nome, 4anoportugues.cpf from 4anoportugues where nome='$nome' = cpf='$cpf'
UNION
SELECT 5anoportugues.nome, 5anoportugues.cpf from 5anoportugues where nome='$nome' = cpf='$cpf'");
//select campo2 from tabela2 where campo2 = 'texto'
$cnt=1;
