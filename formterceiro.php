...
$id=3;
$ret=mysqli_query($con,"select * from terceiroingles where ID='$id'");
$cnt=1;
...
function fMasc3(objeto,mascara) {
obj=objeto
masc=mascara
...
cpfCheck3 = function (el) {
    document.getElementById('cpfResponse3').innerHTML = is_cpf1(el.value)? '<span style="color:green">CPF válido</span>' : '<span style="color:red">CPF inválido</span>';
    if(el.value=='') document.getElementById('cpfResponse3').innerHTML = '';
}
...
<p><input id="cpf" type="text" name="cpf" onkeyup="cpfCheck3(this)"  required class="form-control" maxlength="14" onkeydown="javascript: fMasc3( this, mCPF3 );"> <span id="cpfResponse3"></span></p>
</div>
</div>
...
<div class="col-md-12">
<div class="form-group">
<label><h5><p class="text-danger"> <?php  echo $row['pergunta_13'];?></p></h5>  </label><br>
...
<div class="col-md-12">
<div class="form-group">
<label><h5><p class="text-danger"><?php  echo $row['pergunta_19'];?></p></h5> 
...
<div class="col-md-12">
<div class="form-group">
<label><h5><p class="text-danger"><?php  echo $row['pergunta_20'];?></p></h5>  <br>  </label><br>
 <p>
...
<div class="col-md-12">
<div class="form-group">
<label><h5><p class="text-danger"><?php  echo $row['pergunta_26'];?></p></h5> 
...
<button type="submit"  name="provas3_btn" class="btn btn-primary pull-right">Finalizar</button>
</div>
</div>
