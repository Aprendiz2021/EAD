...
$id = 4;
$ret=mysqli_query($con,"select * from quartoingles where id='$id'");
$cnt=1;
...
function fMasc4(objeto,mascara) {
obj=objeto
masc=mascara
...
cpfCheck4 = function (el) {
    document.getElementById('cpfResponse4').innerHTML = is_cpf1(el.value)? '<span style="color:green">CPF válido</span>' : '<span style="color:red">CPF inválido</span>';
    if(el.value=='') document.getElementById('cpfResponse4').innerHTML = '';
}
...
<p><input id="cpf" type="text" name="cpf" onkeyup="cpfCheck4(this)"  required class="form-control" maxlength="14" onkeydown="javascript: fMasc4( this, mCPF4 );"> <span id="cpfResponse4"></span></p>
</div>
</div>
...
<button type="submit"  name="provas4_btn" class="btn btn-primary pull-right">Finalizar</button>
</div>
</div> 
