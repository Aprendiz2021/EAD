...
<div class="col-md-12">
<div class="form-group"> 
<input type="text " class="form-control" name="pergunta_17"  value="5.	Escreva por extenso os números 9,7,0 e 8. " > <br>
...
<hr/>
  ...
  <button type="submit" name="andressa_btn" class="btn btn-primary pull-right">Adicionar</button>
